...
// Departments
export const departments: Tables["departments"]["Row"][] = [
	{ id: uuidv4(), name: "Engineering", created_at: new Date().toISOString() },
	{ id: uuidv4(), name: "Product", created_at: new Date().toISOString() },
	{ id: uuidv4(), name: "Design", created_at: new Date().toISOString() },
	{
		id: uuidv4(),
		name: "Human Resources",
		created_at: new Date().toISOString(),
	},
	{ id: uuidv4(), name: "Marketing", created_at: new Date().toISOString() },
	{ id: uuidv4(), name: "Finance", created_at: new Date().toISOString() },
	{
		id: uuidv4(),
		name: "Customer Support",
		created_at: new Date().toISOString(),
	},
	{ id: uuidv4(), name: "Sales", created_at: new Date().toISOString() },
	{ id: uuidv4(), name: "Legal", created_at: new Date().toISOString() },
	{
		id: uuidv4(),
...
// Positions
export const positions: Tables["positions"]["Row"][] = [
	{
		id: uuidv4(),
...
// Employees
export const employees: Tables["employees"]["Row"][] = [
	{
		id: uuidv4(),
		first_name: "John",
		last_name: "Doe",
...
// Job Openings
export const jobOpenings: Tables["job_openings"]["Row"][] = [
	{
		id: uuidv4(),
		position: positions[0].id, // Software Engineer
...
// Leave Management
export const leaveManagement: Tables["leave_management"]["Row"][] = [
	{
		id: uuidv4(),
...
// Payroll
export const payroll: Tables["payroll"]["Row"][] = [
	{
		id: uuidv4(),
		employee: employees[0].id, // John Doe
		base_salary: 85000,
